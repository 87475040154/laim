...
class KvartiraFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'tip_obekta' => 'Квартира',
            'tip_sdelki' => fake()->randomElement($array = array ('Сдам','Продам')),
            'table_name' => 'Kvartira',
            ...
            'god_postroiki'=> fake()->numberBetween($min = 1960, $max = 2024),
            ...
            'control'=> fake()->randomElement($array = array ('Активно','Не активно','В архиве')),
            'view'=> fake()->numberBetween($min = 30, $max = 30000),
            'view_tel'=> fake()->numberBetween($min = 30, $max = 30000),
            'count_like'=> fake()->numberBetween($min = 30, $max = 3000),
            'srochno_torg'=> fake()->randomElement([true, false, false, false,false,false]),
            'bue_ads'=> fake()->randomElement($array = array (fake()->dateTimeBetween($startDate = '-5 day', $endDate = 'now', $timezone = null))),
