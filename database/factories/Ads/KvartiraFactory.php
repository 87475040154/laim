...
class KvartiraFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'tip_obekta' => 'Квартира',
            'table_name' => 'Kvartira',
            'zagolovok'=> fake()->text($maxNbChars = 40),
            ...
            'control'=> 'Активно',
            'view'=> fake()->numberBetween($min = 30, $max = 300000),
            'countLike'=> fake()->numberBetween($min = 30, $max = 300000),
            'srochno_torg'=> fake()->randomElement([true, false, false, false,false,false]),
            'bueAds'=> fake()->randomElement($array = array (fake()->dateTimeBetween($startDate = '-1 day', $endDate = 'now', $timezone = null), null, null, null, null, null, null)),
            ...
            'goryachie'=> fake()->randomElement($array = array (fake()->dateTimeBetween($startDate = '-5 day', $endDate = 'now', $timezone = null), null, null, null, null, null, null)),
