...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('zdanies', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('tip_obekta')->default('Здание');
            $table->string('table_name')->default('Zdanie');
