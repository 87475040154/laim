...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ads_view_tels', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('author_id')->nullable(); // ID пользователя, который посмотрел телефон
    ...
    {
        Schema::dropIfExists('ads_view_tels');
    }
};
