...
class Magazin extends Model
{
    ...
    public $fillable = [
        ...
        'sostoyanie', 'mebel', 'internet', 'sanuzel', 'otdelniy_vhod', 'mebel_arr','raznoe','bezopasnost',
        'parkovka', 'pol', 'text_obyavleniya', 'ownerOrRealtor', 'name', 'tel','tel2', 'bueAds', 'top', 'top_8', 'top_x7', 'top_x30'
    ];
